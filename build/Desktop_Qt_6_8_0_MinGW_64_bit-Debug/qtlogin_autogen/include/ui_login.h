...
public:
    ...
    void setupUi(QMainWindow *login)
    {
        ...
        groupBox->setGeometry(QRect(220, 60, 361, 361));
        line_user = new QLineEdit(groupBox);
        line_user->setObjectName("line_user");
        line_user->setGeometry(QRect(190, 100, 113, 21));
        line_pw = new QLineEdit(groupBox);
        line_pw->setObjectName("line_pw");
        line_pw->setGeometry(QRect(190, 160, 113, 21));
        btn_login = new QPushButton(groupBox);
        btn_login->setObjectName("btn_login");
        btn_login->setGeometry(QRect(190, 210, 100, 32));
